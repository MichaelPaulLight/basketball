...
non_agg_test_small <- (non_agg_test
                       |> filter(game_date > "2024-12-10" & game_date < "2024-12-12"))

shot_defense_model_01 <- brm(
  formula = shot_made_flag ~ 
    (1 | game_id) +     # Game-level variation
    (1 | slug_team_off) +   # Offensive Team effect
    (1 | slug_team_def) +
    (1 | offender_name) + 
    (1 | defender_name), 
  data = non_agg_test_small,
  chains = 4,
  iter = 2000,
