...
closest_defender_dashboard <- (closest_defender_dashboard
  |> mutate(o_fga_0_to_10_ft = fg2a - fg2a_10_plus,
            o_fgm_0_to_10_ft = fg2m - fg2m_10_plus)
  |> rename(o_fga_10_to_24_ft = fg2a_10_plus,
            o_fgm_10_to_24_ft = fg2m_10_plus,
...
closest_defender_dashboard <- (closest_defender_dashboard
  |> pivot_longer(
    cols = starts_with("o_"),
    names_to = c("stat_type", "shot_dist_range"),
...
defender_dashboard <- (defender_dashboard |> select(-starts_with("fga_"), -starts_with("fgm_"))
  ...
  |> filter(shot_dist_range == "less_than_6_ft" | 
            shot_dist_range == "6_to_10_ft" | 
            shot_dist_range == "10_to_15_ft" | 
            shot_dist_range == "15_to_24_ft" | 
            shot_dist_range == "24_plus")
)
