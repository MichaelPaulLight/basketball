...
write_parquet(pbp_final_gt, file.path("..", "data", parquet_file_name))
...
lineup_stats |> group_by(lineup) |> summarize(total_pm = sum(plus_minus), mean_pm = mean(plus_minus)) |> arrange(desc(total_pm))
