def player_info(season):
    ...
    async def fetch_play_by_play(session, season):
        url = f"https://stats.nba.com/stats/commonallplayers?IsOnlyCurrentSeason=0&LeagueID=00&Season={season}"
...
if __name__ == '__main__':
    ...
    season = "2024-25"
    player_data = player_info(season)
    print(player_data.head(10))
    pq.write_table(pa.Table.from_pandas(player_data), f'{season}player_info.parquet')
