...
#Passing in Arguments for the script 1) pbp_file 2) defender_dashboard 3) closest_defender_dashboard 4) closest_defender_dashboard_10_plus

args <- commandArgs(trailingOnly = TRUE)
pbp_file <- read_parquet(args[1])
...
pbp_final_df <- read_parquet(pbp_file)
...
defender_dashboard <- nanoparquet::read_parquet(args[2])
...
closest_defender_dashboard <- nanoparquet::read_parquet(args[3])
...
closest_defender_dashboard_10_plus <- nanoparquet::read_parquet(args[4])
