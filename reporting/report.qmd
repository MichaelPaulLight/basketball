...
![R-hat values showing convergence across parameters](images/neg-binom_rhat.png){width="95%" fig-align="center"}
...
![Effective sample sizes for key parameters](images/neff_values.png){width="95%" fig-align="center"}

The effective sample sizes (N_eff) are sufficiently large for all key parameters, ensuring that our posterior summaries are based on adequate independent samples.
